...
SECRET_KEY = 'django-insecure-js1iu9jv!e(1m9!zkqx_jy^em$#@yxg0ajhf%ma=+&v@&vv#5b'
...
# В settings.py
LOGIN_URL = '/users/auth/'  # URL страницы входа
LOGIN_REDIRECT_URL = '/'     # Куда перенаправить после успешного входа
LOGOUT_REDIRECT_URL = '/users/auth/'  # Куда перенаправить после выхода
